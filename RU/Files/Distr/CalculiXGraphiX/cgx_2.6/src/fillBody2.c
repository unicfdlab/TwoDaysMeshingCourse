  ...
  int k;
        ...
        for (v=0; v<svmax; v++)
	{
      ...
      for (u=0; u< div_l[0]+1; u++)
      {
        ...
        o=0;
        nodnr=n_uv[u*svmax +v];
        if ((sb1==0)&&(sa1==3)) { b=u+ offs1            ; a=v                    ;  o=1 ;}
        if ((sb1==3)&&(sa1==2)) { b=vmax-v-1 - offs2   ; a=u                    ;  o=2 ;}
        if ((sb1==2)&&(sa1==1)) { b=umax-u-1 - offs2   ; a=vmax-v-1            ;  o=3 ;}
        if ((sb1==1)&&(sa1==0)) { b=v+ offs1            ; a=umax-u-1            ;  o=4 ;}
        if ((sb1==0)&&(sa1==1)) { b=umax-u-1 - offs2   ; a=v                    ;  o=5 ;}
        if ((sb1==3)&&(sa1==0)) { b=v+ offs1            ; a=u                    ;  o=6 ;}
        if ((sb1==2)&&(sa1==3)) { b=u+ offs1             ; a=vmax-v-1            ;  o=7 ;}
        if ((sb1==1)&&(sa1==2)) { b=vmax-v-1 - offs2   ; a=umax-u-1            ;  o=8 ;}
        n_ba[b* amax +a]=nodnr;
#if TEST
